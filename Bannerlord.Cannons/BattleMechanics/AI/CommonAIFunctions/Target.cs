...
namespace TOR_Core.BattleMechanics.AI.CommonAIFunctions
{
    ...
    {
        private static  readonly ILogger Logger = new ConsoleLoggerFactory().CreateLogger<Target>();
        ...
        public Vec3 GetPosition()
        {
            ...
            {
                Logger.Error("Null error in Bannerlord.Cannons.BattleMechanics.AI.Decision.Target.GetPosition(). Suppressed.");
                return Vec3.Invalid;
            }
        }
        ...
        public Vec3 GetPositionPrioritizeCalculated()
        {
            ...
            {
                Logger.Error("Null error in Bannerlord.Cannons.BattleMechanics.AI.Decision.Target.GetPositionPrioritizeCalculated(). Suppressed.");
                return Vec3.Invalid;
            }
        }
