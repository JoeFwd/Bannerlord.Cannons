...
namespace Bannerlord.Cannons.Integration.Campaign
{
    public class CannonSiegeEventModel : SiegeEventModel
    {
        ...
        public CannonSiegeEventModel(SiegeEventModel previous)
        {
            _previous = previous;
            _availability = new CannonAvailabilityProvider(CannonRegistry.Instance);
            _prefab = new CannonPrefabProvider(CannonRegistry.Instance);
        }
